                    ...
                    >
                      {item?.href ? (
                        <Link
                          ...
                          className={`${pathUrl === item?.href ? "active" : ""} font-heading text-white hover:text-primary inline-flex items-center justify-center text-center text-base dark:hover:text-dark-text ${item?.href?.startsWith("#") ? "menu-scroll" : ""}`}
                        >
                          {item?.title}
                        </Link>
                      ) : (
                        <>
                          <button
                            ...
                            className="submenu-toggler font-heading text-white hover:text-primary inline-flex items-center justify-center text-center text-base dark:hover:text-dark-text"
                          >
                            {item?.title}
