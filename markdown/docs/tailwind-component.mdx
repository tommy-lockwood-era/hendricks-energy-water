...
1. Install Tailwind and generate the config file.
...
3. Update the config file with GrayGrids config.
...
4. Add Tailwind CSS directives to your CSS. Create a CSS file named **input.css** in the root of your project or the **src** directory. Then include this code at the top of the file.
...
5. Generate the CSS file with the build command.
...
6. Include the compiled CSS file in the Html file. We’ve compiled the file in the **dist** folder.
...
### Use GrayGrids with the existing Tailwind Project.
