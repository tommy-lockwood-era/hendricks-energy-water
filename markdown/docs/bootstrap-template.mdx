...
1. Download the template from GrayGrids. When you download the template, you’ll get a zip file.

2. Unzip/Extract the zip file. After you’ve extracted it you’ll find all the files and assets you’ll need.

3. Now open up the folder in your code editor and update the content according to your need.

4. After you’ve updated the content, now go to your cPanel or open your FTP client (like Filezilla) and upload the template on your server. Make sure to upload it to the root directory.
