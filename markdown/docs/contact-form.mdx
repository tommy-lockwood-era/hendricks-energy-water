...
1. Create an account on [FormBold](https://formbold.com/) and create a Form.

2. Integrate the API into your contact Form using this code. Make sure your Form’s method is set to **POST**
